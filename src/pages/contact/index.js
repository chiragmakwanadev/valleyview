      ...
      <div className="flex flex-col xl:flex-row w-full gap-10 padding-x">
        ...
        <div className="flex flex-col w-full xl:w-[50%]">
          ...
          <p className="pt-[30px]" style={{ fontSize: Clamp(1, 1.25) }}>
            ...
            range of services designed to address all of your health care needs.
            From routine check-ups, scheduled appointments to see your family
            doctor, walk-in patient assessments and preventive care, we aim to
            be your one-stop solution for maintaining and enhancing your
            well-being.{" "}
          </p>
          <button
