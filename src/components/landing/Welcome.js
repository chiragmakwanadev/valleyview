    ...
    <div className="padding-x py-[100px] bg-blue-600 text-white flex flex-col xl:flex-row gap-10">
      <div className="w-full xl:w-[50%] flex flex-col gap-5">
        ...
        <div
          ...
          className="flex flex-col gap-4 pr-0 xl:pr-[100px]"
        >
          <p>
          ...
          <p>
            ...
            the highest standard of medical treatment. Our advanced technology
            and modern amenities at our medical clinic in Whitby to support our
      ...
      <img
        src="/images/reception.jpg"
        alt=""
        className="w-full xl:w-[50%] object-cover hidden xl:block"
      />
    </div>
  );
};
